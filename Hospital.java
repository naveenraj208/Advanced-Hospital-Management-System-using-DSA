	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		do {
			...
			case 1:
				...
				do {
					...
					case 1:
						...
						System.out.println("=============================================================================");
						System.out.println("\n\t\t\t\t   WELCOME to");
						System.out.println("\t\t\tBuffer MULTI - SPECIALITY Hospital");
					...
					case 4:
						...
						case 4:
							...
							System.out.println("\n\t\t\t 5.UPDATE A PARTICULAR MEDICINE DATA");
							System.out.println("\n=============================================================================");
							System.out.println("=============================================================================");
							do {
			...
			case 2:
				...
				System.out.println("\n\t\t\t 5.BOOK APPOINTMENT");
				System.out.println("\n\t\t\t 6.REVIEWS");
				System.out.println("\n\t\t\t 7.Cardiovascular Disease Prediction");
				System.out.println("\n\t\t\t 8.AI Chatbot");
				System.out.println("\n\t\t\t 9.Shortest Path to Hospital");
				System.out.println("\n=============================================================================");
				System.out.println("=============================================================================");
				do {
					System.out.print("\nENTER YOUR CHOICE : ");
					...
					case 4:
						...
						case 3:
							...
							if(event_name.equals(event_name))
							{
					...
					case 6:
						...
						break;
					case 7:
						System.out.println("Welcome to Cardiovascular disease Prediction System");
						LogisticRegression.main(args);
						break;
					case 8:
						try {

							ProcessBuilder processBuilder = new ProcessBuilder("python", "ai.py");
							...
							// Create a separate thread to read from the process's input stream and print to standard output
							...
							System.out.println("Process finished with exit code: " + rc);
						...
						break;
					case 9:
						System.out.println("Find the fastest path to hospital because even one second matters");
