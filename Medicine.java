...
public class Medicine {
		...
		else
		{
			...
			for(int i=0;i<no;i++)
			{
				...
				while(count1<=0)
				{
					...
					System.out.print("\nRE - ENTER THE MEDICINE QUANTITY : ");
	...
	public void order() throws IOException
	{
		...
		if(flag==0){
			...
			System.out.println("\n\t\t1.Apolo Medicines");
			System.out.println("\t\t2.Rana Ramdev");
			System.out.println("\t\t3.Medplus");
			System.out.println("\t\t4.Manipal");
			System.out.println("\t\t5.Satya Sai Medicals");
		}
	}
